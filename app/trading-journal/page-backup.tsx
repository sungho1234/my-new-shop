      ...
      <main className="container mx-auto px-4 py-8 max-w-[1900px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-lg p-5 border border-gray-200 shadow-sm">
            ...
            <p className="text-xs text-gray-600">순손익: ${formatNumber(netPnl)}</p>
          </div>
          ...
          <div className="bg-white rounded-lg p-5 border border-gray-200 shadow-sm">
            ...
            <div className="text-2xl font-semibold text-green-600 mb-1 tabular-nums">+${formatNumber(totalProfit)}</div>
            <p className="text-xs text-gray-600">평균: ${formatNumber(avgWin)}</p>
          </div>
          ...
          <div className="bg-white rounded-lg p-5 border border-gray-200 shadow-sm">
            ...
            <div className="text-2xl font-semibold text-red-600 mb-1 tabular-nums">-${formatNumber(totalLoss)}</div>
            <p className="text-xs text-gray-600">평균: ${formatNumber(avgLoss)}</p>
          </div>
        </div>
          ...
          <div className="bg-white rounded-lg p-5 border border-gray-200 shadow-sm">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-semibold text-green-600">${formatNumber(avgWin)}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">평균 손실</span>
                <span className="text-sm font-semibold text-red-600">${formatNumber(avgLoss)}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">총 수수료</span>
                <span className="text-sm font-semibold text-gray-900">${formatNumber(totalFees)}</span>
              </div>
            </div>
          </div>
