                ...
                <div className="bg-white rounded-2xl border border-gray-200 p-8">
                    <div className="flex items-start gap-5 mb-6">
                        ...
                        <div className="flex-1">
                            <h3 className="text-xl font-bold text-gray-900 mb-2">1:1 지원 안내</h3>
                            <p className="text-gray-600 text-base leading-relaxed">
                                이 상품은 1:1 멘토링 및 해설 영상이 제외된 핵심 이론 패키지입니다.
                                실행 지표나 1:1 지원이 필요하신 경우 <span className="font-semibold text-blue-700">"시스템 빌더 풀 패키지"</span>를 이용하시면
            ...
            <div className="w-full bg-white pb-20 min-h-screen">
                ...
                <section className="bg-gradient-to-r from-slate-700 to-slate-800 py-16">
                    <div className="container mx-auto px-4 max-w-7xl text-center">
                        <h1 className="text-3xl font-bold text-white mb-2">프로의 전략 원본</h1>
