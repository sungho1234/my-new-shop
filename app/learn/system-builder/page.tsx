...
const SystemBuilderLearnPage = () => {
    ...
    // 구매 여부 확인
    const hasPurchased = courseAccess.some(access => access.productId === 'system-builder' && access.isActive);

    // 구매 날짜 가져오기
    const purchaseDate = courseAccess.find(access => access.productId === 'system-builder')?.grantedAt;
            ...
            <div className="w-full bg-white pb-20 min-h-screen">
                ...
                <section className="bg-gradient-to-r from-slate-700 to-slate-800 py-16">
                    <div className="container mx-auto px-4 max-w-7xl text-center">
                        <h1 className="text-3xl font-bold text-white mb-2">일반인을 위한 첫번째 안내서</h1>
