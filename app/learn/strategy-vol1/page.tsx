...
const StrategyVol1LearnPage = () => {
    ...
    const hasPurchased = courseAccess.some(access => access.productId === 'strategy-vol1' && access.isActive);

    // 구매 날짜 가져오기
    const purchaseDate = courseAccess.find(access => access.productId === 'strategy-vol1')?.grantedAt;
    ...
    const modules = [
        ...
        { id: 3, number: 'MODULE 03', name: '전략 해설 영상', completed: false, resourceIds: [3] },
        { id: 4, number: 'BONUS', name: '실행 엔진', completed: false, resourceIds: [4] },
    ];
                ...
                <div className="bg-white rounded-2xl border border-gray-200 p-8">
                    <div className="flex items-start gap-5 mb-6">
                        ...
                        <div className="flex-1">
                            <h3 className="text-xl font-bold text-gray-900 mb-2">현역 트레이더 1:1 프라이빗 멘토링</h3>
            ...
            <div className="w-full bg-white pb-20 min-h-screen">
                ...
                <section className="bg-gradient-to-r from-slate-700 to-slate-800 py-16">
                    <div className="container mx-auto px-4 max-w-7xl text-center">
                        <h1 className="text-3xl font-bold text-white mb-2">시스템 빌더 풀 패키지</h1>
