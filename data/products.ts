...
export const ALL_PRODUCTS: Product[] = [
  {
    ...
    author: '모집기간 2025년 12월 20일~2026년 1월 30일',
    price: '107,000',
    thumbnail: '/시스템썸넬후보1.png',
    duration: '365일 수강',
    maxStudents: '49명 모집',
    instructor: 'maxx systems',
    installment: '12개월 할부 시 월 400,000원',
    discount: '73%',
    originalPrice: '총 1,290,000원',
    rating: '5.0',
    reviewCount: '27',
  },
  {
  ...
  },
  {
    ...
    id: 'growth-book',
    title: '파이썬(Python)으로 구현하는 고성능 매매 로직 & 리스크 관리 시스템',
    author: '모집기간 2025년 12월 3일 ~ 2025년 12월 19일',
    price: '240,000',
    thumbnail: '/완판상품이미지.png',
    duration: '무제한 수강',
    maxStudents: '32명 모집',
    instructor: 'maxx systems',
    installment: '12개월 할부 시 월 500,000원',
    discount: '60%',
    originalPrice: '총 2,880,000원',
    rating: '4.9',
    reviewCount: '30',
  },
  {
